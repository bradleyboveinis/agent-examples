---
name: revise
description: Edits the report to answer every review finding, and records what it changed.
agent: editor
model: sonnet
...
isolation: none
gate: deterministic
inputs: [report_path, findings_path, claims_path, verdicts_path]
outputs: [report_path, revision_log_path]
---
